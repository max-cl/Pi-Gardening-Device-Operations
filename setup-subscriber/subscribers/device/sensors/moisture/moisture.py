...
def on_message(client, userdata, msg):
    ...
    print({ "date": dataJson["date"], "sensorId": ObjectId(dataJson["sensorId"]), "deviceId": ObjectId(dataJson["deviceId"]), "value": dataJson["value"] })
    insert_document(collection, { "date": str(dataJson["date"]), "sensorId": ObjectId(dataJson["sensorId"]), "deviceId": ObjectId(dataJson["deviceId"]), "value": dataJson["value"] })
